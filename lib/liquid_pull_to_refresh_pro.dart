library liquid_pull_to_refresh_pro;
...
/// [LiquidPullToRefreshPro] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [LiquidPullToRefreshPro.onRefresh].
...
class LiquidPullToRefreshPro extends StatefulWidget {
  const LiquidPullToRefreshPro({
    Key? key,
  ...
  @override
  LiquidPullToRefreshProState createState() => LiquidPullToRefreshProState();
}

class LiquidPullToRefreshProState extends State<LiquidPullToRefreshPro>
    with TickerProviderStateMixin<LiquidPullToRefreshPro> {
  ...
  ///
  /// Creating the [LiquidPullToRefreshPro] with a [GlobalKey<LiquidPullToRefreshState>]
  /// makes it possible to refer to the [LiquidPullToRefreshProState].
  ///
  /// The future returned from this method completes when the
  /// [LiquidPullToRefreshPro.onRefresh] callback's future completes.
  ///
